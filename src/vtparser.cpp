...
bool VtParser::isInitialized() const
{
	return m_initialized;
}

uint32_t VtParser::getRate() const
{
	return m_rate;
}

uint64_t VtParser::getLastTs() const
{
	return m_lastTs;
}

void VtParser::feed(const uint8_t *buf, size_t sz)
{
...
void VtParser::feedHeaderByte(uint8_t byte)
{
...
void VtParser::feedDataByte(uint8_t byte)
{
	m_buf.push_back(byte);
